        ...
        >
          ...
          <DCInputField label="Сделка" withComment fullWith>
            <div className="add-card_flex add-card-fieldsBlock">
              <DCInputField label="Тип сделки" labelSize="subheader">
                <DCButtonGroup
                  buttons={[
                    {
                      label: "Продажа",
              ...
              <DCInputField label="Вид недвижимости" labelSize="subheader">
                <DCButtonGroup
                  buttons={[
                    {
                      label: "Жилая",
          ...
          <DCInputField label="Тип недвижимсоти" labelSize="subheader" fullWith>
            <DCButtonGroup
              buttons={[
                {
                  label: "Квартира",
          ...
          <div className="add-card_flex add-card-fieldsBlock _col-12">
            <DCInputField label="Собственники" labelSize="subheader">
              <DCButtonGroup
                buttons={[
                  {
                    label: "1",
          ...
          <DCInputField label="Условия продажи" withComment fullWith>
            <div className="add-card_flex add-card-fieldsBlock">
              ...
              <DCInputField label="Мусоропровод" labelSize="subheader">
                <DCButtonGroup
                  buttons={[
                    {
                      label: "Да",
          ...
          <DCInputField label="Дополнительно" fullWith>
            ...
            <DCInputField withComment labelSize="subheader" label="Парковка">
              <DCCheckboxGroup
                group={[
                  {
                    name: "inArea",
            ...
            <DCInputField withComment label="Санузел" labelSize="subheader">
              <DCButtonGroup
                buttons={[
                  {
                    label: "Совмещенный",
            ...
            <DCInputField withComment label="Ремонт" labelSize="subheader">
              <DCButtonGroup
                buttons={[
                  {
                    label: "Косметический",
            ...
            <DCInputField withComment labelSize="subheader" label="Вид из окон">
              <DCCheckboxGroup
                group={[
                  {
                    name: "dvor",
          ...
          <DCInputField withComment label="Дом" fullWith>
            ...
            <DCInputField withComment label="Тип дома" labelSize="subheader">
              <DCButtonGroup
                buttons={[
                  {
                    label: "Кирпичный",
            ...
            <DCInputField withComment label="Лифт" labelSize="subheader">
              <DCButtonGroup
                buttons={[
                  {
                    label: "1",
            ...
            <div className="add-card_flex add-card_wrapReverse add-card-fieldsBlock">
              <DCInputField label="Номер квартиры" labelSize="subheader">
                <DCInput />
              </DCInputField>

              <DCInputField label="или" labelSize="small" labelColor="blue" />

              <DCInputField label="Кадастровый номер" labelSize="subheader">
                <DCInput />
              </DCInputField>
            </div>
          </DCInputField>
          ...
          <DCInputField
            ...
            fullWith
          >
            <DCInputField label="Количество комнат" labelSize="subheader">
              <DCButtonGroup
                buttons={[
                  {
                    label: "1",
            ...
            <div className="add-card_flex add-card-fieldsBlock">
              ...
              <DCInputField label="Площадь кухни" labelSize="subheader">
                <DCInput />
              </DCInputField>

              <DCInputField label="Жилая площадь" labelSize="subheader">
                <DCInput />
              </DCInputField>
              ...
              <DCInputField label="Этажей в доме" labelSize="subheader">
                <DCInput />
              </DCInputField>

              <DCInputField label="Высота потолков" labelSize="subheader">
                <DCInput />
              </DCInputField>
            </div>
          </DCInputField>
