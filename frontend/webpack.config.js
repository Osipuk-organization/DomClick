...
module.exports = {
  ...
  plugins: [
    ...
    new HTMLplugin({
      template: path.resolve(__dirname, 'pug', 'pages', 'user-profile-edit.pug'),
      filename: 'user-profile-edit.html',
      minify: false,
    }),
    new HTMLplugin({
      template: path.resolve(__dirname, 'pug', 'pages', 'product-page.pug'),
